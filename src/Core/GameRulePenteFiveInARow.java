 ...
 */
public class GameRulePenteFiveInARow implements GameRule {
	...
	public GameRulePenteFiveInARow () {
	...
	// iterate through the sequence
		...
		if ( state.whiteCaptures_ >= captureCountToWin_ && capturesWin_) {
			return GamePiece.BLACK;
		}
		if ( state.blackCaptures_ >= captureCountToWin_ && capturesWin_) {
