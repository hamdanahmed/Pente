...
/**
 *  GameRule for the Pente No-Captures game variant
 */

public class GameRulePenteNoCaptures implements GameRule {
	...
	public GameRulePenteNoCaptures () {
		blackCaptures_ = 0;
		whiteCaptures_ = 0;
	}
	...
	/* (non-Javadoc)
	 * @see GameRule#evalCapture(java.util.List, GameState)
	 */
	@Override
	public GamePiece evalCapture ( List<Move> sequence, GameState state ) {
		// not needed for no captures variant
		return null;
	}
